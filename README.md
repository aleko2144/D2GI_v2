...
* `FixAlpha` - включить или выключить исправление отрисовки прозрачных зон на объектах, имеющих неправильное расположение в иерархии рендеринга (это нужно только в некоторых модификациях игрового мира)
